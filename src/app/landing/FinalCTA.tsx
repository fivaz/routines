...
export function FinalCTA() {
	return (
		<section className="relative overflow-hidden bg-gray-900 px-6 py-32">
			{/* Background Image */}
			...
			<div className="relative z-10 mx-auto max-w-4xl text-center">
				<h2 className="mb-6 text-white">Start Simple. Stay Consistent.</h2>
				...
				<div className="mt-16 grid grid-cols-1 gap-6 md:grid-cols-3">
					<div className="rounded-lg border border-gray-700 bg-gray-800/50 p-6 backdrop-blur-sm">
						...
						<div className="text-gray-300">Focus on today only</div>
					</div>
					<div className="rounded-lg border border-gray-700 bg-gray-800/50 p-6 backdrop-blur-sm">
						<div className="mb-2 text-green-500">✓</div>
						<div className="text-gray-300">Reduce overwhelm</div>
					</div>
					<div className="rounded-lg border border-gray-700 bg-gray-800/50 p-6 backdrop-blur-sm">
						<div className="mb-2 text-green-500">✓</div>
						<div className="text-gray-300">Build lasting habits</div>
					</div>
				</div>
			</div>
		</section>
